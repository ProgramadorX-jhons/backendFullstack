...
import com.progrmadorX_jhons.aplicactionFullStackBakend_lunes.repository.CartRepository;
import com.progrmadorX_jhons.aplicactionFullStackBakend_lunes.repository.UserRepository;
import com.progrmadorX_jhons.aplicactionFullStackBakend_lunes.request.LoginRequest;
import com.progrmadorX_jhons.aplicactionFullStackBakend_lunes.response.AuthResponse;
import com.progrmadorX_jhons.aplicactionFullStackBakend_lunes.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    @Autowired
    private JwtProvider jwtProvider;  // Asegúrate de que esto se inyecta correctamente
    @Autowired
    ...
    @PostMapping("/signin")
    public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest rep) {

        String username = rep.getEmail();
